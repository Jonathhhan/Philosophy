...
- markiert: TragfÃ¤higkeit
- unmarkiert: normativer ObermaÃŸstab
- Kontext: Kapitel 15 und Schluss

## Ermoeglichte Anschluesse

- `unterscheidungsautomat` -> `tractatus_automat`
  - gemeinsame Begriffsadressen: aktualisieren, anschliessen, asymmetrie, fortsetzen, kommunikation, moeglichkeitsraum, organisieren, programm
  - gemeinsame Manuskriptanker: manuskript\05-aktualisieren.md:47, manuskript\07-programm.md:59, manuskript\11-organisieren.md:77, manuskript\13-asymmetrie.md:89, manuskript\14-kritisieren.md:13
- `tractatus_automat` -> `kunstwerk_automat`
  - gemeinsame Begriffsadressen: aktualisieren, anschliessen
  - gemeinsame Begriffsadressen: aktualisieren, anschliessen, revidieren

## Verbundlauf

### 1. Unterscheiden: TragfÃ¤higkeit / normativer ObermaÃŸstab
- Markierte Begriffsadressen: aktualisieren, anschliessen, asymmetrie, fortsetzen, kommunikation, moeglichkeitsraum
- Unmarkierte Begriffsadressen: aktualisieren, anschliessen, asymmetrie, fortsetzen, kommunikation, moeglichkeitsraum

### 2. Propositional ordnen

- 1 Leitsatz: TragfÃ¤higkeit / normativer ObermaÃŸstab: Kapitel 15 und Schluss ist als Ordnung möglicher Anschlüsse zu prüfen, nicht als isolierte Behauptung.
...
- 2.1 Nachbarbegriff: Anschließen bildet eine mögliche Anschlussadresse für die weitere Prüfung.
- 2.2 Nachbarbegriff: Asymmetrie bildet eine mögliche Anschlussadresse für die weitere Prüfung.

### 3. Auffuehren / Score erzeugen

```text
01: markiere Anschließen; fuehre normativer ObermaÃŸstab als unmarkierte Seite mit.
