...
Gedanke: Automatenläufe: dramaturgische Verdichtung, Tragfähigkeit, Einleitung als Ordnung

Status: unbestimmt; als Vorschlag oder TODO behandeln, bis der Autor entscheidet

## Erkannte Begriffe
- Keine deklarierte Begriffsadresse erkannt.

## Benachbarte Anschlussstellen
- Keine weiteren deklarierten Nachbarbegriffe gefunden.

## Manuskriptanker
- Keine Ankersuche ausgeführt oder kein Anker gefunden.

## Projektgrenzen
- Keine automatische Grenzwarnung ausgelöst.

## Textvorschlag

TODO: Vorschlag des Philosophie-Automaten; nicht als bestätigte Theorie behandeln.

Der Gedanke lautet: Automatenläufe: dramaturgische Verdichtung, Tragfähigkeit, Einleitung als Ordnung. Er ist zunächst als mögliche Anschlussstelle zu prüfen. Er berührt die betroffene Anschlussstelle und darf deshalb nicht als isolierte Formulierung übernommen werden. Zu klären ist, ob er eine bestehende Definition verändert, eine Anwendung präzisiert oder lediglich einen Einwand markiert.
