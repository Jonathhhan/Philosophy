...
Der geteilte Chat „buch“ wurde in `archive/chat-index.yaml` datenschutzbereinigt kartiert. Die nicht privaten Nutzerprompts 104 bis 429 sind mit Ausnahme des privaten Prompts 107 wörtlich in `archive/chats/book-chat.user-prompts.md` gesichert. Die Assistentenantworten zu diesem Bereich sind in `archive/chats/book-chat.assistant-answers.redacted.md` gesichert; Antwort 107 ist vollständig ausgeschlossen und private Abschnitte in acht gemischten Antworten sind sichtbar redigiert. Die Karte unterscheidet private Ausschlussbereiche, Quellenbesprechungen, Theorieentwicklung, Manuskriptentwürfe, Kapitelanalysen und mögliche Autorenbestätigungen. Alle Rekonstruktionen bleiben einzeln zu prüfen.

Prompt 397 ist zusätzlich in `recovered/manuscript/chapter-01-prompt-397.md` als quellenkritisches Rekonstruktionsdossier isoliert. Das Dossier trennt den wörtlich erhaltenen Kapitelbeginn von der metatextuellen Autorenäußerung, vermerkt die unsichere Endung „Bru“ und hält fest, dass keine unmittelbar zugehörige Assistentenantwort überliefert ist.
...
- Neu angelegt: `manuskript/10-stabilisieren.md` als eigenständige Fassung; das frühere Werk-Kapitel wurde nicht umbenannt.
- Integriert: relative Dauer, Wiedererkennbarkeit, fortgesetzte Wirksamkeit, materielle und technische Träger, Identität trotz Variation, Abschluss, Freigabe und relative Eigenständigkeit.
- Systematisch eingeordnet: Werk als besonderer Fall der Stabilisierung; normative Rechtfertigung bleibt von bloßem Fortbestand getrennt.
...
- Umgesetzt: Doppelung zu Blockierung in Kapitel 2 gekürzt, analytischer Übergang von Problematisieren zu Form präzisiert und „Anschlussraum“ terminologisch vereinheitlicht.
- Umgesetzt: wiederholte technische Nacherzählungen des `Alphaville`-Versuchs in den Kapiteln 4 bis 7 und 9 reduziert; Kapitel 3 bleibt die Problemgeschichte, Kapitel 8 die ausführliche technische Analyse.
- Umgesetzt: Übergang von Kapitel 9 zu Kapitel 10 gestrafft und mehrere gleichförmige Schlussformeln variiert.
- Unverändert: Kapitelarchitektur, Grunddefinitionen und konkrete epistemische Funktion der Montage.

## Interaktive Ausgabe – Stabilisierung 2026-07-29

- Bearbeitet: `interaktiv/index.html`, `interaktiv/css/main.css` und `interaktiv/js/main.js`.
- Ergänzt: Fassungen können festgehalten, als vorläufig maßgeblich freigegeben und später wiederaufgenommen werden.
- Sichtbar gemacht: Die laufende Form kann von einer stabilisierten Fassung abweichen, während diese adressierbar und wiederaufnehmbar bleibt.
