...
def main() -> int:
    ...
    run([python, "-m", "py_compile", "automation/generative_runner.py", "automation/generative_schemas.py"])
    run([python, "-m", "unittest", "tests/test_generative_runner.py", "tests/test_generative_runner_hardening.py"] )
