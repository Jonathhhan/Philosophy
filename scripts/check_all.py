...
def main() -> int:
    ...
    run([python, "-m", "py_compile", "automation/generative_runner.py", "automation/generative_schemas.py", "automation/artifact_bundle.py"])
    run([python, "-m", "unittest", "discover", "-s", "tests", "-p", "test_generative*.py"])
    run([python, "-m", "unittest", "tests/test_research_program.py"])
    run([python, "automation/research_program.py", "validate", "program", "automation/requests/research-program-example.yaml"])
    run([python, "automation/research_program.py", "validate", "experiment", "automation/requests/experiment-example.yaml"])
